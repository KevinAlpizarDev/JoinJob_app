...
//     emailjs
//       .send(
//         "service_z56t7bt", // Reemplaza con tu Service ID de Mail.js
//         "template_jq8yw6s", // Reemplaza con tu Template ID de Mail.js
//         {
//           to_name: userName, // Pasa el nombre del usuario
//           from_name: "JoinJob", // Nombre del remitente
//           message:
//             "Hi friend! JoinJob is waiting for you to explore amazing opportunities!", // Mensaje adaptado
//         },
//         "U9UAIoXdwQOs7-Ktb" // Reemplaza con tu Public Key (User ID) de Mail.js
//       )
//       .then(
//         (result) => {
