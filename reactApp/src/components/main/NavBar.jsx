...
export default function NavBar({ isLoggedIn, onLogout }) {
  ...
  return (
    <nav className="w-full bg-gray-200 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {isDropdownOpen && (
              ...
              //   <LanguageToggle />
              // </div>
              <div className="absolute top-[15vh] left-[88%] transform -translate-x-1/2 w-[13vw] h-[20vh] dark:bg-gray-800 rounded-lg shadow-lg z-20 py-4 flex flex-col items-center justify-between transition-all duration-300">
