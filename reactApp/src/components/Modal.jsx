...
import { useAuth } from "../components/AuthProvider"; // Asegúrate de importar tu contexto de autenticación
...
const Modal = ({ courseId }) => {
  ...
  if (!user) {
    return <p>Por favor, inicie sesión para inscribirse en el curso.</p>;
  }
