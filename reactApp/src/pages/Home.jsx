...
// import React, { useState, useEffect } from "react";
// import { Link, useNavigate } from "react-router-dom"; // Importar useNavigate para redireccionar
// import { checkLoggedInUser, handleLogout } from "../services/service"; // Importar las funciones de servicios
// import CourseList from "../components/CourseList"; // Importar el componente de lista de cursos
// import NavBar from "../components/main/NavBar"; // Importar la barra de navegación
// import FooterPage from "../components/FooterPage"; // Importar el pie de página
...
//         setLoggedIn(true); // Marcar al usuario como logueado
//         setUsername(user.username); // Establecer el nombre de usuario desde la respuesta
//         console.log(user.is_staff);
//       } catch (error) {
//         setLoggedIn(false); // Si hay un error, marcar al usuario como no logueado
//         setUsername(""); // Limpiar el nombre de usuario
//       }
//     };
//     verifyUser(); // Llamar a la función para comprobar el estado de logueo
//   }, []); // Ejecutar solo al montar el componente

//   const handleLogoutClick = async () => {
//     try {
//       await handleLogout(); // Usar la función de servicios para cerrar sesión
//       setLoggedIn(false); // Establecer estado de logueo como falso
//       setUsername(""); // Limpiar el nombre de usuario
//       navigate("/account"); // Navegar a la ruta de cuenta después de cerrar sesión
//     } catch (error) {
//       console.error("Failed to logout", error.message); // Manejo de errores en caso de fallo
//     }
//   };
...
//             <Logout/>
//             <CourseList />{" "}
//             {/* Aquí puedes agregar el componente de lista de cursos */}
//           </>
//         ) : (
//           <Link to="/account">Please log in</Link>
//         )}
//       </div>
//       <FooterPage /> {/* Pie de página */}
//     </>
//   );
// }
