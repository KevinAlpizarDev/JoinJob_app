...
//         <p className="text-xl text-center mt-4 text-[#457B9D]">
...
//           </div>
//           <div className="p-6">
//             <div className="bg-[#E9ECEF] h-40 rounded-lg mb-4"></div>
...
//               <div className="bg-[#E9ECEF] h-32 rounded-lg"></div>
//               <div className="bg-[#E9ECEF] h-32 rounded-lg"></div>
//               <div className="bg-[#E9ECEF] h-32 rounded-lg"></div>
//             </div>
...
//               quis tortor orci. Etiam at risus et justo dignissim congue.
//             </p>
//           </div>
//         </div>
//       </div>
...
{/* <div className="flex justify-between items-center w-full p-4 px ">
