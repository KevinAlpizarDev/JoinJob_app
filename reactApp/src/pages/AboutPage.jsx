...
//           <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
//             {/* Card Item */}
//             <div className="flex items-start space-x-4 p-6 bg-primary-light dark:bg-primary-dark rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200">
//               <div className="mt-1 h-6 w-6 flex-none bg-green-500 rounded-full"></div>
//               <div>
//                 <h3 className="text-xl leading-8 font-semibold text-tertiary-dark dark:text-primary-light">
//                   Capacitación para PYMEs
//                 </h3>
//                 <p className="mt-2 text-gray-500 dark:text-tertiary-light font-poppins">
//                   Programas de formación para fortalecer pequeñas y medianas
//                   empresas, cubriendo temas como ventas, marketing y gestión
//                   empresarial.
//                 </p>
